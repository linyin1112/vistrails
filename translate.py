            ...
            j = 0
                ...
                for i in range(0, len(inportname)):
                    ...
                    count['add'] += 1
                        ...
                        outterport[i] = ElementTree.SubElement(addport[i], 'portSpec')
...
if mod.type == 'FileSink':
    ...
    mod.value = '/Users/yinlin/Desktop/s15/ga/download/nodes-to-vt-test/result.txt'
        add_value = True
...
for link in links:
    act = ElementTree.SubElement(vt, 'action')
        ...
        try:
            ...
            port.attrib['name'] = str(inportname[i])#inportname[0]
        try:
        ...
        try:
            ...
            port2.attrib['name'] = str(inportname[i])
        try:
